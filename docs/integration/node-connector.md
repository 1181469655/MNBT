---
title: MNBT 节点连接器
description: MNBT 私有宝塔面板 Python 插件，支持违禁词扫描、站点访问统计与远程查询
---
...
| `get_site_client_stats` | site, date | 客户端分布 |
| `get_site_method_stats` | site, date | 请求方式统计 |
...
> 源码目录：`bt_plugins/mnbt_connector/`
