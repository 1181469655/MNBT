---
title: 售卖前端（shop_frontend）
description: 统一商店前端皮肤插件：接管站点首页与 user_info、balance、hosting_shop 的全部用户端页面
---
...
- [balance](./balance.md) — 余额依赖插件
- [hosting_shop](./hosting-shop.md) — 主机商店依赖插件
- [首页接管与通用路由](../route.md) — P2 路由系统 API
- [菜单与页面](../menu.md) — 页面接管（Page Override）API
