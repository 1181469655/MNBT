...
function mnbtdocker_MetaData() {
    return [
        ...
        'APIVersion'  => '1.1',
        'HelpDoc'     => 'https://github.com/MNBT/Docker_API.md', // 指向 MNBT Docker_API.md 在线地址
    ];
}
```
