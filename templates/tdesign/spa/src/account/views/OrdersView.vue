<template>
  <div class="td-page">
    <div class="td-page-head">
      <div>
        <h3 class="td-page-title"><i class="mdi mdi-receipt"></i> 我的订单</h3>
        <p class="td-page-subtitle">查看主机购买订单与支付状态</p>
      </div>
    ...
    <t-empty v-else description="暂无订单" style="padding: 60px 0">
...
import { getShopOrders, centsToYuan } from '@/account/api/plugins'
...
async function load() {
  const res = await getShopOrders(page.value, perPage)
  if (!res.ok) return
