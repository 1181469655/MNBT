  ...
  <div class="td-login">
    ...
    <div class="login-banner">
      ...
      <div class="banner-content">
        ...
        <p class="banner-subtitle">管理后台 · 安全可控的运维管理平台</p>
        <ul class="banner-features">
          <li><i class="mdi mdi-shield-check-outline"></i> 多层安全防护</li>
          <li><i class="mdi mdi-chart-timeline-variant"></i> 实时数据监控</li>
          <li><i class="mdi mdi-server-network"></i> 集群节点管理</li>
        </ul>
      </div>
    </div>
      ...
      <div class="login-card">
        ...
        <t-form ref="formRef" :data="form" :rules="rules" :label-width="0" @submit="onSubmit">
          <t-form-item name="user">
            <t-input v-model="form.user" placeholder="管理员账号" clearable size="large" @enter="onSubmit">
...
async function onSubmit({ validateResult }) {
  ...
  if (res.ok) {
    ...
    window.__TD_BOOT__ = { ...boot, loggedIn: true, adminUser: form.user.trim() }
