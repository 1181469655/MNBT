...
.ly-login-footer {
  margin: 20px 0 0; text-align: center; font-size: 12px;
...
<div class="ly-login-wrap">
  <div class="ly-login-card">
    ...
    <form action="#!" method="post" class="ly-login-form" onsubmit="return false;">
      <div class="ly-field">
        <div class="ly-input-wrap">
          <i class="mdi mdi-account ly-input-icon" aria-hidden="true"></i>
          <input type="text" class="ly-input" id="username" placeholder="用户名 / 账号" autocomplete="username">
        </div>
      </div>
      <div class="ly-field">
        <div class="ly-input-wrap">
...
<?php if ($conf['yzme'] == 'true') { ?>
      <div class="ly-field">
        <div class="ly-captcha-row">
          ...
          <img id="captcha" src="./code.php?r=<?php echo time(); ?>" class="ly-captcha-img" onclick="this.src='./code.php?r='+Math.random();" title="点击更换验证码" alt="验证码">
        </div>
      </div>
<?php } ?>
      <div class="ly-field" style="margin-bottom:0">
        <button class="ly-btn-login" type="button" onclick="chkre()">登 录</button>
      </div>
    </form>
