...
$(function(){
	$('#dkUserTable').bootstrapTable({
		...
		columns: [
			...
			{field:'disk_usage', title:'磁盘用量', formatter:function(v){ v=parseInt(v,10)||0; if(v<=0) return '-'; if(v<1073741824) return (v/1048576).toFixed(1)+' MB'; return (v/1073741824).toFixed(2)+' GB'; }},
			{field:'data', title:'开通'},
