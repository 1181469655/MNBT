                ...
                <div class="sidebar-gradient flex flex-col p-6 md:p-8 w-full md:w-64 flex-shrink-0">
                    <div class="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-xs leading-none mt-1" style="color: rgba(255, 255, 255, 0.5);">V<span class="mn-vs">1.83</span> 安装向导</p>
                        </div>
                    </div>
                                ...
                                <div>
                                    <div class="flex items-center gap-4 mb-6">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted-foreground text-sm mt-0.5">版本 V<span class="mn-vs">1.83</span> &middot; 约需 2 分钟</p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="new-install-select d-none">
                                            ...
                                            <div class="install-type-btn">
                                                <div class="flex items-start gap-3 p-3 rounded-xl border mb-3 cursor-pointer transition-all duration-200 use-terms mn-upgrade" style="border-color: var(--border); background: var(--card); user-select: none;">
                                                    ...
                                                    <div>
                                                        <p class="text-sm font-medium text-foreground">覆盖更新（保留数据升级到 V1.83）<span class="mn-upgrade-detail" style="font-weight:normal;color:var(--muted-foreground)"></span></p>
                                                        <p class="text-xs text-muted-foreground mt-0.5">添加 V1.83 新增表和字段，自动补全缺失项，保留所有已有数据</p>
                                                    </div>
                                                </div>
            ...
            if(result.data.in_table){
                ...
                if(upgradeInfo.code === 1 && upgradeInfo.data){
                    if(upgradeInfo.data.need_upgrade){
                        ...
                        $('.mn-upgrade-detail').text('（当前已是 V1.83，无需升级）');
                        $('.mn-upgrade').parent().show();
                        $('.mn-repair').parent().show();
                    }
                } else {
